		...
		<nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 shadow-sm">
			<div class="container-fluid">
				<a class="navbar-brand" href="{{ route('login')}}">
					<img src="{{ asset('backend/assets/images/login-images/benue-logo.png') }}" width="50" alt="" />
				</a>
				<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent1" aria-controls="navbarSupportedContent1" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span>
				</button>
				<div class="collapse navbar-collapse" id="navbarSupportedContent1">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"> <a class="nav-link active" aria-current="page" href="{{ route('login')}}"><i class='bx bx-home-alt me-1'></i>Home</a>
						</li>
					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								...
								<p>You've reached the edge of the universe.
									<br>The page you're looking for cannot be found.
									<br>Don't worry you can return to the previous page.</p>
								<div class="mt-5"> <a href="{{ route('login')}}" class="btn btn-primary btn-lg px-md-5 radius-30">Go Home</a>
									<a href="{{ route('login')}}" class="btn btn-outline-dark btn-lg ms-3 px-md-5 radius-30">Back</a>
								</div>
							</div>
						</div>
						<div class="col-xl-7">
