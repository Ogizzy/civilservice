	...
	<div class="wrapper">
							...
							<div class="card-body p-sm-5">
								<div class="">
									<div class="mb-3 text-center">
										<img src="{{ asset('backend/assets/images/login-images/benue-logo.png') }}" width="60" alt="">
									</div>
     ...
     <form class="row g-3" method="POST" action="{{ route('login') }}">
            ...
            <div class="col-12">
                ...
                <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" id="inputEmailAddress" placeholder="marcel@gmail.com">
                @error('email')
            ...
            <div class="col-12">
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary">Sign in</button>
									...
									<div class="login-separater text-center mb-5"> <span><marquee> Benue State Civil Servants Application </marquee></span>
										<hr>
									</div>
