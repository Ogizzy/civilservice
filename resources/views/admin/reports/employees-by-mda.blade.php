            ...
            <div class="row mb-4">
                ...
                @if (!empty($genderStats))
                    @foreach ($genderStats as $gender => $count)
                        <div class="col-md-3">
                            <div
                                class="card border-0 shadow-sm {{ $gender == 'Male' ? 'bg-info' : 'bg-danger' }} text-white">
                                <div class="card-body d-flex align-items-center">
                                    <div
                                        class="rounded-circle bg-white {{ $gender == 'Male' ? 'text-info' : 'text-danger' }} p-3 me-3">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        ...
                        <span
                            class="fw-bold text-primary">{{ optional($employees->first())->mda->mda ?? 'Selected MDA' }}</span>
                    </h5>
                            ...
                            <tbody>
                                @foreach ($employees as $emp)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $emp->gender == 'Male' ? 'info' : 'secondary' }} bg-opacity-10 text-{{ $emp->gender == 'Male' ? 'info' : 'danger' }} px-2 py-1">
                                                <i
                                                    class="bx {{ $emp->gender == 'Male' ? 'bx-male' : 'bx-female' }} me-1"></i>
                                                {{ $emp->gender }}
                                            </span>
                                        </td>
                                        <td>{{ $emp->rank }}</td>
                                        ...
                                        <td class="pe-4">
                                            Grade Level {{ $emp->gradeLevel->level ?? 'N/A' }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
