                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="row g-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select @error('religion') is-invalid @enderror"
                                                        ...
                                                        <option value="Islam"
                                                            ...
                                                            Islam</option>
                                                        <option value="Others"
                                                            {{ old('religion', $employee->religion) == 'Others' ? 'selected' : '' }}>
                                                            Others</option>
                                                    </select>
                                                    @error('religion')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="state_id" class="form-label">State of Origin <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-select @error('state_id') is-invalid @enderror"
                                                        ...
                                                        @foreach ($states as $state)
                                                            <option value="{{ $state->id }}"
                                                                {{ old('state_id', $employee->state_id) == $state->id ? 'selected' : '' }}>
                                                                {{ $state->state }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select class="form-select @error('lga') is-invalid @enderror"
                                                        ...
                                                        @foreach ($lgas as $lga)
                                                            <option value="{{ $lga->lga }}"
                                                                {{ old('lga', $employee->lga) == $lga->lga ? 'selected' : '' }}>
                                                                {{ $lga->lga }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control @error('contact_address') is-invalid @enderror" id="contact_address"
                                                        name="contact_address" rows="2">{{ old('contact_address', $employee->contact_address) }}</textarea>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="paygroup_id" class="form-label">Pay Group <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-select @error('paygroup_id') is-invalid @enderror"
                                                        id="paygroup_id" name="paygroup_id" required>
                                                        <option value="">Select Pay Group</option>
                                                        @foreach ($payGroups as $payGroup)
                                                            <option value="{{ $payGroup->id }}"
                                                                {{ old('paygroup_id', $employee->paygroup_id) == $payGroup->id ? 'selected' : '' }}>
                                                                {{ $payGroup->paygroup }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="level_id" class="form-label">Grade Level <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="step_id" class="form-label">Step <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-select @error('step_id') is-invalid @enderror"
                                                        id="step_id" name="step_id" required>
                                                        <option value="">Select Step</option>
                                                        @foreach ($steps as $step)
                                                            <option value="{{ $step->id }}"
                                                                {{ old('step_id', $employee->step_id) == $step->id ? 'selected' : '' }}>
                                                                {{ $step->step }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    <label for="first_appointment_date" class="form-label">First
                                                        Appointment Date</label>
                                                    <input type="date"
                                                        class="form-control @error('first_appointment_date') is-invalid @enderror"
                                                        id="first_appointment_date" name="first_appointment_date"
                                                        value="{{ old('first_appointment_date', $employee->first_appointment_date ? $employee->first_appointment_date->format('Y-m-d') : '') }}">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    <label for="confirmation_date" class="form-label">Confirmation
                                                        Date</label>
                                                    <input type="date"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    <label for="present_appointment_date" class="form-label">Present
                                                        Appointment Date</label>
                                                    <input type="date"
                                                        class="form-control @error('present_appointment_date') is-invalid @enderror"
                                                        id="present_appointment_date" name="present_appointment_date"
                                                        value="{{ old('present_appointment_date', $employee->present_appointment_date ? $employee->present_appointment_date->format('Y-m-d') : '') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control @error('qualifications') is-invalid @enderror" id="qualifications"
                                                        name="qualifications" rows="3">{{ old('qualifications', $employee->qualifications) }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" step="0.01"
                                                        class="form-control @error('net_pay') is-invalid @enderror"
                                                        id="net_pay" name="net_pay"
                                                        value="{{ old('net_pay', $employee->net_pay) }}">
                                                    @error('net_pay')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                    ...
                    .then(data => {
                        ...
                        data.forEach(dept => {
                            ...
                            if (isEditMode && selectedDepartmentId == dept.id) {
                                opt.selected = true;
                                loadUnits(dept.id, true); // Load units also in edit mode
                            }
    ...
    <script>
        ...
        const stateLGA = {
            "Abia": ["Aba North", "Aba South", "Arochukwu", "Bende", "Ikwuano", "Isiala Ngwa North",
                ...
                "Ukwa West", "Umuahia North", "Umuahia South", "Umunneochi"
            ],
